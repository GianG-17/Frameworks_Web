...
<section class="page">
	...
	<nav class="tabs">
		<button class:active={aba === 'espelho'} onclick={() => (aba = 'espelho')}
			>Espelho individual</button
		>
		<button class:active={aba === 'consolidado'} onclick={() => (aba = 'consolidado')}
			>Consolidado mensal</button
		>
	</nav>
		...
		{#if conResult}
			<div class="card">
				...
				<table>
					<thead>
						<tr>
							<th>Colaborador</th><th>Dias</th><th>Horas</th><th>Extras</th><th>Déficit</th><th
								>Férias</th
							><th>Justificadas</th>
						</tr>
					</thead>
