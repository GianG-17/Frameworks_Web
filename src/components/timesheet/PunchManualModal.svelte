...
<script lang="ts">
  ...
  let { aberto, colaboradorNome, dataInicial, tipoInicial, onFechar, onConfirmar }: Props = $props();
    ...
    <form class="modal" role="dialog" aria-modal="true" onsubmit={handleSubmit}>
      ...
      <div class="modal-body">
        <p class="aviso">
          ...
          <strong>{colaboradorNome}</strong>. Conforme a Portaria 671/2021, batidas não podem
          ser editadas — apenas adicionadas ou anuladas. O motivo ficará registrado no histórico.
        </p>
...
<style>
  ...
  .btn--primario { background: #3b82f6; color: #fff; }
